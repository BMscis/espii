...
class Acrcloud_Monitor_API:
    ...
    def set_result_callback(self, project_name, result_callback_url, send_noresult=False, post_data_type="json", result_type="realtime"):
        ...
        #r.encoding = "utf-8"
        r2 = r.json()
        with open('/var/www/html/src/espii_db/stations/station_name/calbk.json', 'wb') as json_file:
    ...
    def get_channel_results(self, project_name, channel_id,channel_name, date):
        ...
        #r.encoding = "utf-8"
        r2 = r.json()
        with open('/var/www/html/src/espii_db/stations/station_data/{}.json'.format(channel_name), 'wb') as json_file:
            json.dump(r2, json_file)
...
if __name__ == "__main__":
    ...
    try:
        with open('/var/www/html/src/espii_db/stations/station_name/channel_list.json','w') as ch:
